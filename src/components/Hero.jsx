...
function Hero() {
  return (
    <section aria-labelledby="hero-title" className="relative isolate flex flex-col overflow-hidden bg-[#071016] lg:block lg:h-[clamp(34rem,44vw,39rem)]">
      ...
      <div className="absolute inset-x-0 top-0 -z-10 aspect-[1137/709] w-full bg-[linear-gradient(180deg,rgba(4,12,16,0.42)_0%,rgba(4,12,16,0.06)_18%,rgba(4,12,16,0)_55%,rgba(7,16,22,0.76)_84%,#071016_100%)] lg:hidden" />
      ...
      <Navbar />
      <div dir="ltr" className="flex w-full justify-center px-5 pb-5 pt-[calc(62.36vw-3rem)] sm:px-8 lg:absolute lg:inset-x-0 lg:top-16 lg:bottom-[5.6rem] lg:flex-1 lg:items-end lg:justify-end lg:px-[3.5%] lg:pb-10 lg:pt-0">
