...
function Hero() {
  return (
    <section aria-labelledby="hero-title" className="relative isolate flex min-h-[42rem] flex-col overflow-hidden bg-[#071016] lg:block lg:h-[clamp(34rem,44vw,39rem)] lg:min-h-0">
      <img src={heroImage} alt="محصولات روشنایی نامی نور در محوطه یک کارخانه مدرن" className="absolute inset-x-0 top-0 bottom-[42%] -z-20 w-full object-cover object-[22%_center] lg:inset-0 lg:size-full lg:object-center" />
      ...
      <Navbar />
      <div dir="ltr" className="flex w-full flex-1 items-end justify-center px-5 pb-5 pt-12 sm:px-8 lg:absolute lg:inset-x-0 lg:top-16 lg:bottom-[5.6rem] lg:justify-end lg:px-[3.5%] lg:pb-10 lg:pt-0">
